...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000a43ec6b7ecd3fc9005f619b1c7d833bc9248fc2a3805ee6906ee11c1412"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1530819563, // * UNIX timestamp of last checkpoint block
...
public:
	...
	pchMessageStart[2] = 0xc4;
        ...
        const char* pszTimestamp = "Duel Platform Initiated";
        ...
        genesis.nNonce = 22075361;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000f7a14df2c0ca4fd10b6188dcc5b58754fac8bb748a83bd5a10086dd6dd4"));
        assert(genesis.hashMerkleRoot == uint256("0x10f4a8a42dd7d67e0629f5ba0b8be97d58bd38e42ff7220784e413227295017a"));
        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("104.238.141.120", "104.238.141.120"));
        vSeeds.push_back(CDNSSeedData("149.28.82.62", "149.28.82.62"));
        vSeeds.push_back(CDNSSeedData("149.28.88.23", "149.28.88.23"));
        ...
        // Duelium BIP44 coin type is '222' (0x800000de)
