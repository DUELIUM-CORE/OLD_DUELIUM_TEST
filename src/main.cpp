...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight > 1 && nHeight <= 21)
        nSubsidy = 43750 * COIN;
    else if (nHeight > 21 && nHeight <= 8887)
        nSubsidy = 1 * COIN;
    else if (nHeight > 8887 && nHeight <= 18887)
        nSubsidy = 20 * COIN;
    else if (nHeight > 18887 && nHeight <= 38887)
        nSubsidy = 10 * COIN;
    else if (nHeight > 38887 && nHeight <= 58887)
        nSubsidy = 5 * COIN;
    else if (nHeight > 58887 && nHeight <= 88887)
        nSubsidy = 2.5 * COIN;
    else if (nHeight > 88887 && nHeight <= 99999)
        nSubsidy = 8 * COIN;
    else
        nSubsidy = 2 * COIN;
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // DL: We use certain sporks during IBD, so check to see if they are
