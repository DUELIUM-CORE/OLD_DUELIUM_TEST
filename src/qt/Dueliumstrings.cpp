...
QT_TRANSLATE_NOOP("Duelium-core", ""
"Disable all Duelium specific functionality (Masternodes, SwiftTX, "
...
QT_TRANSLATE_NOOP("Duelium-core", "(8887 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("Duelium-core", "(default: %s)"),
QT_TRANSLATE_NOOP("Duelium-core", "(default: 1)"),
QT_TRANSLATE_NOOP("Duelium-core", "(must be 8887 for mainnet)"),
...
QT_TRANSLATE_NOOP("Duelium-core", "Enable publish hash transaction (locked via SwiftTX) in <address>"),
...
QT_TRANSLATE_NOOP("Duelium-core", "Enable publish raw transaction (locked via SwiftTX) in <address>"),
...
QT_TRANSLATE_NOOP("Duelium-core", "SwiftTX options:"),
